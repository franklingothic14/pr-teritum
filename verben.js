const verben = [
  ...
  { infinitiv: "streichen", praeteritum: "strich", perfekt: "hat gestrichen", gruppe: "ei → ie", uk: "малювати/креслити", en: "to paint/stroke", hu: "festeni/húzni" },
  { infinitiv: "streiten", praeteritum: "stritt", perfekt: "hat gestritten", gruppe: "ei → ie", uk: "сперечатися", en: "to argue", hu: "vitatkozni" },
  { infinitiv: "treiben", praeteritum: "trieb", perfekt: "hat getrieben", gruppe: "ei → ie", uk: "гнати/займатися", en: "to drive/do", hu: "hajtani/űzni" },
  { infinitiv: "weisen", praeteritum: "wies", perfekt: "hat gewiesen", gruppe: "ei → ie", uk: "вказувати", en: "to point", hu: "mutatni" },
  ...
  { infinitiv: "verleihen", praeteritum: "verlieh", perfekt: "hat verliehen", gruppe: "ei → ie", uk: "позичати/видавати", en: "to lend/award", hu: "kölcsönadni/adományozni" },
  ...
  { infinitiv: "sinken", praeteritum: "sank", perfekt: "ist gesunken", gruppe: "i → a", uk: "тонути/падати", en: "to sink", hu: "süllyedni" },
  { infinitiv: "springen", praeteritum: "sprang", perfekt: "ist gesprungen", gruppe: "i → a", uk: "стрибати", en: "to jump", hu: "ugrani" },
  { infinitiv: "stinken", praeteritum: "stank", perfekt: "hat gestunken", gruppe: "i → a", uk: "смердіти", en: "to stink", hu: "bűzölni" },
  ...
  // ie → o
  { infinitiv: "fliegen", praeteritum: "flog", perfekt: "ist geflogen", gruppe: "ie → o", uk: "літати", en: "to fly", hu: "repülni" },
  ...
  { infinitiv: "riechen", praeteritum: "roch", perfekt: "hat gerochen", gruppe: "ie → o", uk: "нюхати/пахнути", en: "to smell", hu: "szagolni" },
  { infinitiv: "schießen", praeteritum: "schoss", perfekt: "hat geschossen", gruppe: "ie → o", uk: "стріляти", en: "to shoot", hu: "lőni" },
  { infinitiv: "schließen", praeteritum: "schloss", perfekt: "hat geschlossen", gruppe: "ie → o", uk: "зачиняти", en: "to close", hu: "zárni" },
  { infinitiv: "verlieren", praeteritum: "verlor", perfekt: "hat verloren", gruppe: "ie → o", uk: "втрачати", en: "to lose", hu: "elveszíteni" },
  { infinitiv: "ziehen", praeteritum: "zog", perfekt: "hat/ist gezogen", gruppe: "ie → o", uk: "тягнути/переїжджати", en: "to pull/move", hu: "húzni/költözni" },
  { infinitiv: "wiegen", praeteritum: "wog", perfekt: "hat gewogen", gruppe: "ie → o", uk: "важити", en: "to weigh", hu: "mérni" },
  { infinitiv: "biegen", praeteritum: "bog", perfekt: "hat/ist gebogen", gruppe: "ie → o", uk: "згинати", en: "to bend", hu: "hajlítani" },
  { infinitiv: "bieten", praeteritum: "bot", perfekt: "hat geboten", gruppe: "ie → o", uk: "пропонувати", en: "to offer", hu: "kínálni" },

  // e → a
  { infinitiv: "brechen", praeteritum: "brach", perfekt: "hat/ist gebrochen", gruppe: "e → a", uk: "ламати", en: "to break", hu: "törni" },
  ...
  { infinitiv: "fressen", praeteritum: "fraß", perfekt: "hat gefressen", gruppe: "e → a", uk: "жерти", en: "to devour", hu: "falni" },
  { infinitiv: "geben", praeteritum: "gab", perfekt: "hat gegeben", gruppe: "e → a", uk: "давати", en: "to give", hu: "adni" },
  { infinitiv: "gelten", praeteritum: "galt", perfekt: "hat gegolten", gruppe: "e → a", uk: "діяти/бути дійсним", en: "to be valid", hu: "érvényes lenni" },
  { infinitiv: "geschehen", praeteritum: "geschah", perfekt: "ist geschehen", gruppe: "e → a", uk: "відбуватися", en: "to happen", hu: "történni" },
  ...
  { infinitiv: "tragen", praeteritum: "trug", perfekt: "hat getragen", gruppe: "a → u", uk: "носити", en: "to carry", hu: "hordani" },
  ...
  { infinitiv: "erschaffen", praeteritum: "erschuf", perfekt: "hat erschaffen", gruppe: "a → u", uk: "творити", en: "to create", hu: "teremteni" },
  ...
  { infinitiv: "lassen", praeteritum: "ließ", perfekt: "hat gelassen", gruppe: "a → ie", uk: "залишати/дозволяти", en: "to let/leave", hu: "hagyni/engedni" },
  { infinitiv: "laufen", praeteritum: "lief", perfekt: "ist gelaufen", gruppe: "a → ie", uk: "бігти", en: "to run", hu: "futni" },
  { infinitiv: "raten", praeteritum: "riet", perfekt: "hat geraten", gruppe: "a → ie", uk: "радити/вгадувати", en: "to advise/guess", hu: "tanácsolni/kitalálni" },
  ...
  { infinitiv: "stoßen", praeteritum: "stieß", perfekt: "hat/ist gestoßen", gruppe: "a → ie", uk: "штовхати", en: "to push", hu: "lökni" },
  ...
  { infinitiv: "verderben", praeteritum: "verdarb", perfekt: "hat/ist verdorben", gruppe: "e → o", uk: "псувати", en: "to spoil", hu: "elrontani" },
  { infinitiv: "werfen", praeteritum: "warf", perfekt: "hat geworfen", gruppe: "e → o", uk: "кидати", en: "to throw", hu: "dobni" },
  { infinitiv: "erwerben", praeteritum: "erwarb", perfekt: "hat erworben", gruppe: "e → o", uk: "здобувати", en: "to acquire", hu: "szerezni" },
  ...
  { infinitiv: "wissen", praeteritum: "wusste", perfekt: "hat gewusst", gruppe: "Mischverben", uk: "знати (факт)", en: "to know (fact)", hu: "tudni" },
  ...
  { infinitiv: "liegen", praeteritum: "lag", perfekt: "hat/ist gelegen", gruppe: "Besondere", uk: "лежати", en: "to lie", hu: "feküdni" },
  ...
  { infinitiv: "stehen", praeteritum: "stand", perfekt: "hat/ist gestanden", gruppe: "Besondere", uk: "стояти", en: "to stand", hu: "állni" },
  ...
  // Modalverben
  { infinitiv: "dürfen", praeteritum: "durfte", perfekt: "hat gedurft", gruppe: "Modalverben", uk: "мати дозвіл", en: "may/to be allowed", hu: "szabad/engedélyezett" },
  { infinitiv: "können", praeteritum: "konnte", perfekt: "hat gekonnt", gruppe: "Modalverben", uk: "могти", en: "can/to be able", hu: "tudni/képes lenni" },
  { infinitiv: "mögen (*)", praeteritum: "mochte (*)", perfekt: "hat gemocht (*)", gruppe: "Modalverben", uk: "любити", en: "to like", hu: "szeretni" },
  { infinitiv: "möchten", praeteritum: "mochte", perfekt: "hat gemocht", gruppe: "Modalverben", uk: "хотіти", en: "would like", hu: "szeretne" },
  { infinitiv: "müssen", praeteritum: "musste", perfekt: "hat gemusst", gruppe: "Modalverben", uk: "мусити", en: "must/to have to", hu: "kell/muszáj" },
  { infinitiv: "sollen", praeteritum: "sollte", perfekt: "hat gesollt", gruppe: "Modalverben", uk: "повинен", en: "should/to be supposed to", hu: "kellene/köteles" },
